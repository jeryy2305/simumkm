...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-blue-950 flex flex-col justify-center py-8 px-4 sm:py-12 sm:px-6 lg:px-8 relative overflow-hidden font-sans">
            ...
            <div className="mx-auto w-full max-w-xs sm:max-w-md relative z-10">
                ...
                <h2 className="mt-1 sm:mt-2 text-center text-2xl sm:text-3xl font-extrabold text-white tracking-tight">
            ...
            <div className="mt-6 sm:mt-8 mx-auto w-full max-w-xs sm:max-w-md relative z-10">
                <div className="bg-white py-8 px-4 sm:py-10 sm:px-6 shadow-2xl sm:rounded-3xl border border-gray-100 rounded-2xl">
                    ...
                    {error && (
                        <div className="mb-4 sm:mb-6 rounded-lg sm:rounded-xl bg-red-50 border border-red-200 p-3 sm:p-4 text-xs sm:text-sm text-red-700 flex items-start">
                    ...
                    <form className="space-y-4 sm:space-y-6" onSubmit={handleLogin}>
                        <div>
                            ...
                            <div className="relative rounded-lg sm:rounded-xl shadow-sm">
                                ...
                                <input
                                    ...
                                    className="block w-full pl-9 sm:pl-11 pr-3 sm:pr-4 py-2.5 sm:py-3 border border-gray-200 rounded-lg sm:rounded-xl focus:ring-2 focus:ring-blue-600 focus:border-blue-600 bg-gray-50 text-gray-900 text-sm transition-all outline-none"
                        ...
                        <div className="pt-1 sm:pt-2">
                            <button
                                type="submit"
                                disabled={isLoading}
                                className="w-full flex justify-center items-center py-3 sm:py-3.5 px-3 sm:px-4 rounded-lg sm:rounded-xl text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 shadow-lg shadow-blue-600/30 transition-all active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed cursor-pointer"
                            >
                                {isLoading ? (
                                    <>
