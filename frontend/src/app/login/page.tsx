...
import { Building2, Mail, Lock, LogIn, ArrowLeft, Eye, EyeOff } from "lucide-react";
                        ...
                        <div>
                            ...
                            <div className="relative rounded-xl shadow-sm">
                                ...
                                <input
                                    ...
                                    placeholder="••••••••"
                                />
                                <button type="button" onClick={() => setShowPassword(v => !v)} className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-500 icon-toggle" aria-label="Toggle password visibility">
